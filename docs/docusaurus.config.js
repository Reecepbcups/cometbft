...
const organizationName = "cometbft";
const projectName = "cometbft";

/** @type {import('@docusaurus/types').Config} */
const config = {
  title: "Cometbft",
  tagline: "Documentation for CometBFT",
